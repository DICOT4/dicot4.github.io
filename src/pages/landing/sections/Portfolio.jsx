                            ...
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-1.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Web</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-2.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>App</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-3.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Card</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-4.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Web</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-5.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>App</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-6.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Card</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-7.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-card">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Card</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-8.jpg" data-gall="portfolioGallery"
                        ...
                        <div className="col-lg-4 col-md-6 portfolio-item filter-web">
                            <div className="portfolio-wrap">
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <p>Web</p>
                                    <div className="portfolio-links">
                                        <a href="images/portfolio/portfolio-9.jpg" data-gall="portfolioGallery"
                                           className="venobox" title="Web 3"><i className="bx bx-plus"/></a>
                                        <a href="portfolio-details.html" title="More Details"><i
                                            className="bx bx-link"/></a>
                                    </div>
